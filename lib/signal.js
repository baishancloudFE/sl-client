...
// 客户端信号
exports.CLIENT_INIT = Buffer.from([0x00])
exports.CLIENT_FILE_CHANGE = Buffer.from([0x01])
exports.CLIENT_FILE_DELETE = Buffer.from([0x02])
exports.CLIENT_FILE_CHECK = Buffer.from([0x03])
exports.CLIENT_FILE_SYNC = Buffer.from([0x04])
exports.CLIENT_NUMBER_OF_CHECK_FILES = Buffer.from([0x05])
exports.CLIENT_DEVELOPMENT = Buffer.from([0x06])
exports.CLIENT_BUILD = Buffer.from([0x07])
exports.CLIENT_SYNC_FILES_MD5 = Buffer.from([0x08])

// 服务端信号
exports.SERVER_INIT_DONE = 0xFF
exports.SERVER_FILE_UPDATE = 0xFE
exports.SERVER_CHECK_OFF = 0xFD
exports.SERVER_DEV_SERVER_START = 0xFC
exports.SERVER_BUILD_FILE_SYNC = 0xFB
exports.SERVER_CONSOLE = 0xBB
